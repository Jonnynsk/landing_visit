...
const PainsSection = () => {
  ...
  return (
    <section id="pains" className="py-20 bg-light-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {content.pains.items.map((item, index) => {
            ...
            return (
              <div key={index} className="animate-slide-up" style={{ animationDelay: `${index * 0.1}s` }}>
                <div className="bg-light-card rounded-2xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 h-full">
        ...
        <div className="bg-gradient-to-r from-primary/10 to-accent/10 rounded-2xl p-8 animate-fade-in">
          <h3 className="text-2xl font-bold text-light-text mb-6 text-center">
